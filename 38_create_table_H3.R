...
#################################################
##                                             ##
## PROGRAM NAME: 38_create_table_H3            ##
## AUTHOR: GW                                  ##
##                                             ##
## PURPOSE: create table of estimates for the  ##
##          disparity eliminated among white   ##
##          students                           ##
##                                             ##
#################################################
#################################################
...
##### SELECT SUBSAMPLE #####
eclsk.mi <- eclsk.mi[which(eclsk.mi$drace_1==1),]
...
##### PRINT RESULTS #####
sink("C:\\Users\\Geoffrey Wodtke\\Desktop\\projects\\nhood_schl_gaps\\programs\\_LOGS\\38_create_table_H3_log.txt")
