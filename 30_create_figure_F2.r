...
eclsk.mi <- eclsk.mi[which(eclsk.mi$nhpovrt1>=0.20 | eclsk.mi$nhpovrt1<=0.10),]
...
##### PRINT RESULTS #####
sink("C:\\Users\\Geoffrey Wodtke\\Desktop\\projects\\nhood_schl_gaps\\programs\\_LOGS\\30_create_figure_F2_log.txt")
