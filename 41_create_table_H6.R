...
#################################################
##                                             ##
## PROGRAM NAME: 41_create_table_H6            ##
## AUTHOR: GW                                  ##
##                                             ##
...
##### SELECT SUBSAMPLE #####
eclsk.mi <- eclsk.mi[which(eclsk.mi$drace_3==1),]
...
##### PRINT RESULTS #####
sink("C:\\Users\\Geoffrey Wodtke\\Desktop\\projects\\nhood_schl_gaps\\programs\\_LOGS\\41_create_table_H6_log.txt")

cat("===========================================\n")
cat("HISPANIC STUDENTS\n")
cat("===========================================\n")
cat("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
