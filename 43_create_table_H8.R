...
#################################################
##                                             ##
## PROGRAM NAME: 43_create_table_H8            ##
## AUTHOR: GW                                  ##
##                                             ##
## PURPOSE: create table of estimates for the  ##
##          disparity eliminated among upper   ##
##          class students                     ##
##                                             ##
#################################################
#################################################
...
##### PRINT RESULTS #####
sink("C:\\Users\\Geoffrey Wodtke\\Desktop\\projects\\nhood_schl_gaps\\programs\\_LOGS\\43_create_table_H8_log.txt")

cat("===========================================\n")
cat("STUDENTS WITH A COLLEGE EDUCATED PARENT\n")
cat("===========================================\n")
cat("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
