...
#################################################
##                                             ##
## PROGRAM NAME: 42_create_table_H7            ##
##                                             ##
## PURPOSE: create table of estimates for the  ##
##          disparity eliminated among lower   ##
##          class students                     ##
##                                             ##
#################################################
#################################################
...
##### SELECT SUBSAMPLE #####
eclsk.mi <- eclsk.mi[which(eclsk.mi$pared2=="Less than high school diploma" | eclsk.mi$pared2=="High school diploma or equivalent"),]
...
##### PRINT RESULTS #####
sink("C:\\Users\\Geoffrey Wodtke\\Desktop\\projects\\nhood_schl_gaps\\programs\\_LOGS\\42_create_table_H7_log.txt")

cat("===========================================\n")
cat("STUDENTS WITHOUT A COLLEGE EDUCATED PARENT\n")
cat("===========================================\n")
cat("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
