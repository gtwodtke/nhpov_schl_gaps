...
##### SELECT SUBSAMPLE #####
eclsk.mi <- eclsk.mi[which(eclsk.mi$dx1region_1==1 | eclsk.mi$dx1region_2==1),]
...
##### PRINT RESULTS #####
sink("C:\\Users\\Geoffrey Wodtke\\Desktop\\projects\\nhood_schl_gaps\\programs\\_LOGS\\44_create_table_H9_log.txt")

cat("===========================================\n")
cat("MIDWEST/NORTHEAST\n")
cat("===========================================\n")
cat("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
