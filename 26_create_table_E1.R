...
#################################################
##                                             ##
## PROGRAM NAME: 26_create_table_E1            ##
##                                             ##
## PURPOSE: create table of estimates for the  ##
##          disparity eliminated using 4th     ##
##          grade test scores                  ##
##                                             ##
#################################################
#################################################
...
mi.results <- foreach(i=1:nmi, .combine=cbind) %dopar% {
  ...
  eifEst$summand.rd.com <- (eifEst$hipovnh * eifEst$wt1.com * (eifEst$rdtheta8 - eifEst$yhat.x1.base.rd.com)
  ...
  eifEst$summand.rd.res <- (eifEst$hipovnh * eifEst$wt1.res * (eifEst$rdtheta8 - eifEst$yhat.x1.base.rd.res)
  ...
  eifEst$summand.rd.ins <- (eifEst$hipovnh * eifEst$wt1.ins * (eifEst$rdtheta8 - eifEst$yhat.x1.base.rd.ins)
  ...
  eifEst$summand.rd.cli <- (eifEst$hipovnh * eifEst$wt1.cli * (eifEst$rdtheta8 - eifEst$yhat.x1.base.rd.cli)
  ...
  eifEst$summand.rd.efx <- (eifEst$hipovnh * eifEst$wt1.efx * (eifEst$rdtheta8 - eifEst$yhat.x1.base.rd.efx)
  ...
  eifEst$summand.mt.com <- (eifEst$hipovnh * eifEst$wt1.com * (eifEst$mththeta8 - eifEst$yhat.x1.base.mt.com)
  ...
  eifEst$summand.mt.res <- (eifEst$hipovnh * eifEst$wt1.res * (eifEst$mththeta8 - eifEst$yhat.x1.base.mt.res)
  ...
  eifEst$summand.mt.ins <- (eifEst$hipovnh * eifEst$wt1.ins * (eifEst$mththeta8 - eifEst$yhat.x1.base.mt.ins)
  ...
  eifEst$summand.mt.cli <- (eifEst$hipovnh * eifEst$wt1.cli * (eifEst$mththeta8 - eifEst$yhat.x1.base.mt.cli)
  ...
  eifEst$summand.mt.efx <- (eifEst$hipovnh * eifEst$wt1.efx * (eifEst$mththeta8 - eifEst$yhat.x1.base.mt.efx)
  ...
  var.res.rd <- lm_robust((rdtheta8 - summand.rd.res)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.ins.rd <- lm_robust((rdtheta8 - summand.rd.ins)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.cli.rd <- lm_robust((rdtheta8 - summand.rd.cli)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.efx.rd <- lm_robust((rdtheta8 - summand.rd.efx)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  ...
  var.res.mt <- lm_robust((mththeta8 - summand.mt.res)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.ins.mt <- lm_robust((mththeta8 - summand.mt.ins)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.cli.mt <- lm_robust((mththeta8 - summand.mt.cli)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.efx.mt <- lm_robust((mththeta8 - summand.mt.efx)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
...
##### PRINT RESULTS #####
sink("C:\\Users\\Geoffrey Wodtke\\Desktop\\projects\\nhood_schl_gaps\\programs\\_LOGS\\26_create_table_E1_log.txt")
