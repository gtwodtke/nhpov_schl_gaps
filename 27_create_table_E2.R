...
#################################################
##                                             ##
## PROGRAM NAME: 27_create_table_E2            ##
##                                             ##
## PURPOSE: create table of estimates for the  ##
##          disparity eliminated using 5th     ##
##          grade test scores                  ##
##                                             ##
#################################################
#################################################
...
##### RECODE VARIABLES ######
eclsk.mi$rdtheta9 <- (eclsk.mi$rdtheta9-mean(eclsk.mi$rdtheta9))/sqrt(var(eclsk.mi$rdtheta9))
eclsk.mi$mththeta9 <- (eclsk.mi$mththeta9-mean(eclsk.mi$mththeta9))/sqrt(var(eclsk.mi$mththeta9))
...
##### SETUP SUPERLEARNER #####
cntrl.sl.cv <- SuperLearner.CV.control(V=kfolds)
...
mi.results <- foreach(i=1:nmi, .combine=cbind) %dopar% {
  ...
  muhat0.rd <- mean(eclsk[which(eclsk$hipovnh==0), "rdtheta9"])
  muhat1.rd <- mean(eclsk[which(eclsk$hipovnh==1), "rdtheta9"])
  muhat0.mt <- mean(eclsk[which(eclsk$hipovnh==0), "mththeta9"])
  muhat1.mt <- mean(eclsk[which(eclsk$hipovnh==1), "mththeta9"])
  ...
  eifEst <- eclsk[, c(vars.meta, "k", "hipovnh", "rdtheta9", "mththeta9")]
  ...
  for (j in 1:kfolds) {
    ...
    read.mod.base.com <- SuperLearner(
      Y=eclsk[which(eclsk$k!=j), "rdtheta9"],
    ...
    math.mod.base.com <- SuperLearner(
      Y=eclsk[which(eclsk$k!=j), "mththeta9"],
      X=eclsk[which(eclsk$k!=j), c("hipovnh", vars.base, vars.schl.com)],
      SL.library=c("SL.lm", "customRF_1", "customGBTree_1"),
      cvControl=cntrl.sl.cv)
  ...
  eifEst$summand.rd.com <- (eifEst$hipovnh * eifEst$wt1.com * (eifEst$rdtheta9 - eifEst$yhat.x1.base.rd.com)
  ...
  eifEst$summand.rd.res <- (eifEst$hipovnh * eifEst$wt1.res * (eifEst$rdtheta9 - eifEst$yhat.x1.base.rd.res)
  ...
  eifEst$summand.rd.ins <- (eifEst$hipovnh * eifEst$wt1.ins * (eifEst$rdtheta9 - eifEst$yhat.x1.base.rd.ins)
  ...
  eifEst$summand.rd.cli <- (eifEst$hipovnh * eifEst$wt1.cli * (eifEst$rdtheta9 - eifEst$yhat.x1.base.rd.cli)
  ...
  eifEst$summand.rd.efx <- (eifEst$hipovnh * eifEst$wt1.efx * (eifEst$rdtheta9 - eifEst$yhat.x1.base.rd.efx)
  ...
  eifEst$summand.mt.com <- (eifEst$hipovnh * eifEst$wt1.com * (eifEst$mththeta9 - eifEst$yhat.x1.base.mt.com)
  ...
  eifEst$summand.mt.res <- (eifEst$hipovnh * eifEst$wt1.res * (eifEst$mththeta9 - eifEst$yhat.x1.base.mt.res)
  ...
  eifEst$summand.mt.ins <- (eifEst$hipovnh * eifEst$wt1.ins * (eifEst$mththeta9 - eifEst$yhat.x1.base.mt.ins)
  ...
  eifEst$summand.mt.cli <- (eifEst$hipovnh * eifEst$wt1.cli * (eifEst$mththeta9 - eifEst$yhat.x1.base.mt.cli)
  ...
  eifEst$summand.mt.efx <- (eifEst$hipovnh * eifEst$wt1.efx * (eifEst$mththeta9 - eifEst$yhat.x1.base.mt.efx)
  ...
  # VARIANCE #
  var.obs.rd <- lm_robust(rdtheta9~hipovnh, cluster=schlid, se_type="stata", data=eclsk)$std.error["hipovnh"]^2  
  var.com.rd <- lm_robust((rdtheta9 - summand.rd.com)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.res.rd <- lm_robust((rdtheta9 - summand.rd.res)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.ins.rd <- lm_robust((rdtheta9 - summand.rd.ins)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.cli.rd <- lm_robust((rdtheta9 - summand.rd.cli)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.efx.rd <- lm_robust((rdtheta9 - summand.rd.efx)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  
  var.obs.mt <- lm_robust(mththeta9~hipovnh, cluster=schlid, se_type="stata", data=eclsk)$std.error["hipovnh"]^2  
  var.com.mt <- lm_robust((mththeta9 - summand.mt.com)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.res.mt <- lm_robust((mththeta9 - summand.mt.res)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.ins.mt <- lm_robust((mththeta9 - summand.mt.ins)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.cli.mt <- lm_robust((mththeta9 - summand.mt.cli)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
  var.efx.mt <- lm_robust((mththeta9 - summand.mt.efx)~1, cluster=schlid, se_type="stata", data=eifEst)$std.error^2
...
##### PRINT RESULTS #####
sink("C:\\Users\\Geoffrey Wodtke\\Desktop\\projects\\nhood_schl_gaps\\programs\\_LOGS\\27_create_table_E2_log.txt")
